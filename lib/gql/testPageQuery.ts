...
import { TestPagePartsFragmentDoc, TestPage } from '@/tina/__generated__/types'
...
export default createFullQuery(TestPageQuery) + TestPagePartsFragmentDoc
